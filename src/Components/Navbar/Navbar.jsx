...
export default function Navbar() {
  ...
  let { countWishlist, getLoggedWishlist, setCountWishlist } =
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav ms-auto mb-md-2 mb-lg-0">
              <li className="nav-item socialMedia">
              ...
              {userToken ? (
                <>
                  ...
                  <li className="nav-item d-flex align-items-center pfp">
                    <Link to={"profile"}>
                    ...
                    <Link className="position-relative" to={"/cart"}>
                      ...
                      {numOfCartItems !== 0 ? (
                        <div className="bg-danger font-sm-2 text-white position-absolute top-50 start-50 translate-middle-x rounded-circle ">
                          {numOfCartItems}
                        </div>
                      ) : (
                        ""
                    ...
                    <Link to={"wishlist"}>
                      ...
                      {Number(countWishlist) !== 0 ? (
                        <div className="bg-danger font-sm-2 text-white position-absolute top-50 start-50 translate-middle-x rounded-circle px-1">
                          {countWishlist}
                        </div>
                      ) : (
                        ""
